										...
										<tr>
											<td style="font-family: Helvetica, Arial, sans-serif; color: #1F2858; font-size: 14px; line-height: 1.3; font-weight: 400; padding-bottom: 22px;">
												<?php if ( $data['double_opt_in'] ) : ?>
													<?php esc_html_e( 'You opted to follow the conversation at', 'subscribe-to-comment-notifications-comment-converter' ); ?>
												<?php else : ?>
													<?php esc_html_e( "You're now following the conversation at", 'subscribe-to-comment-notifications-comment-converter' ); ?>
												<?php endif; ?>
												<br />
											...
											<td style="padding-bottom: 16px;">
												<?php if ( $data['double_opt_in'] ) : ?>
													<p style="color: #454D74; font-family: Helvetica; font-size: 14px;">
														<?php esc_html_e( 'Click the button below to confirm your subscription.', 'subscribe-to-comment-notifications-comment-converter' ); ?>
													</p>

													<a href="[Confirm_Url]" style="display: inline-block; padding: 16px 24px; border-radius: 3px; background: #067CE1; color: #FFF; font-family: Helvetica; font-size: 20px; text-decoration-line: none;"><?php esc_html_e( 'Confirm', 'subscribe-to-comment-notifications-comment-converter' ); ?></a>
												<?php else : ?>
													<p style="color: #454D74; font-family: Helvetica; font-size: 14px;">
														<?php esc_html_e( 'If you do not recognise this, click the link below to unsubscribe.', 'subscribe-to-comment-notifications-comment-converter' ); ?>
														<a href="[Unsubscribe_Url]" style="color: #067CE1; font-family: Helvetica; font-size: 14px; font-weight: 700; text-decoration-line: underline;"><?php esc_html_e( 'Unsubscribe', 'subscribe-to-comment-notifications-comment-converter' ); ?></a>
													</p>
												<?php endif; ?>
											</td>
										</tr>
										...
										<tr>
											<td style="font-family: Helvetica, Arial, sans-serif; color: #1F2858; font-size: 14px; line-height: 1.3; font-weight: 400;">
												...
												<p style="color: #6C7781; font-family: Helvetica, Arial, sans-serif; font-size: 11px;">
													...
													|
													<!-- [Unsubscribe] -->
													<a href="[Unsubscribe_Url]" style="color: #15C; font-family: Helvetica, Arial, sans-serif; text-decoration-line: underline;"><?php esc_html_e( 'Unsubscribe', 'subscribe-to-comment-notifications-comment-converter' ); ?></a>
													<?php esc_html_e( 'From Following', 'subscribe-to-comment-notifications-comment-converter' ); ?>
